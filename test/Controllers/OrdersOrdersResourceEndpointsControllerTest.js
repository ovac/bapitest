...
const controller = testerlib.OrdersOrdersResourceEndpointsController;
describe("OrdersOrdersResourceEndpointsController Tests", function tests() {
     ...
     */
    it("should testListAllOrdersDisplayAListingOfTheResource response", function testListAllOrdersDisplayAListingOfTheResourceTest(done) {
        controller.listAllOrdersDisplayAListingOfTheResource(function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
