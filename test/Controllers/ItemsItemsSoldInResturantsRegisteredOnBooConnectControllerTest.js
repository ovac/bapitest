...
const controller = testerlib.ItemsItemsSoldInResturantsRegisteredOnBooConnectController;
describe("ItemsItemsSoldInResturantsRegisteredOnBooConnectController Tests", function tests() {
     ...
     */
    it("should testListItemsDisplayAListingOfTheResource response", function testListItemsDisplayAListingOfTheResourceTest(done) {
        controller.listItemsDisplayAListingOfTheResource(function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
