...
import run.booconnect.controllers.AccountAccountEndpointsController;
...
@LargeTest
public class AccountAccountEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static AccountAccountEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getAccountAccountEndpoints();
    }
