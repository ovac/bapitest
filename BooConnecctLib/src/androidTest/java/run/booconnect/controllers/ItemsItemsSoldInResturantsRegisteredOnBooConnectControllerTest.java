...
import run.booconnect.controllers.ItemsItemsSoldInResturantsRegisteredOnBooConnectController;
...
@LargeTest
public class ItemsItemsSoldInResturantsRegisteredOnBooConnectControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static ItemsItemsSoldInResturantsRegisteredOnBooConnectController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getItemsItemsSoldInResturantsRegisteredOnBooConnect();
    }
    ...
    /**
     * Todo Add description for test testListItemsDisplayAListingOfTheResource
     * @throws Throwable
     */
    @Test
    public void testListItemsDisplayAListingOfTheResource() throws Throwable {

        // Set callback and perform API call
        APICallBackCatcher<Object> response = new APICallBackCatcher<Object>();
        controller.setHttpCallBack(httpResponse);
        controller.listItemsDisplayAListingOfTheResourceAsync(response);
        response.getResult();
