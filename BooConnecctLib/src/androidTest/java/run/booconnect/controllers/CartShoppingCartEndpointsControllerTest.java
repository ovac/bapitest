...
import run.booconnect.controllers.CartShoppingCartEndpointsController;
...
@LargeTest
public class CartShoppingCartEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static CartShoppingCartEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getCartShoppingCartEndpoints();
    }
