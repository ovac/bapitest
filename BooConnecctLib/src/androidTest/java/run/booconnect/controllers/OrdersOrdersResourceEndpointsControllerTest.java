...
import run.booconnect.controllers.OrdersOrdersResourceEndpointsController;
...
@LargeTest
public class OrdersOrdersResourceEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static OrdersOrdersResourceEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getOrdersOrdersResourceEndpoints();
    }
    ...
    /**
     * Todo Add description for test testListAllOrdersDisplayAListingOfTheResource
     * @throws Throwable
     */
    @Test
    public void testListAllOrdersDisplayAListingOfTheResource() throws Throwable {

        // Set callback and perform API call
        APICallBackCatcher<Object> response = new APICallBackCatcher<Object>();
        controller.setHttpCallBack(httpResponse);
        controller.listAllOrdersDisplayAListingOfTheResourceAsync(response);
        response.getResult();
