...
import run.booconnect.controllers.CheckoutCheckoutResourceEndpointsController;
...
@LargeTest
public class CheckoutCheckoutResourceEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static CheckoutCheckoutResourceEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getCheckoutCheckoutResourceEndpoints();
    }
