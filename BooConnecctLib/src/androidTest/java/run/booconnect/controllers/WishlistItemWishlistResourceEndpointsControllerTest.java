...
import run.booconnect.controllers.WishlistItemWishlistResourceEndpointsController;
...
@LargeTest
public class WishlistItemWishlistResourceEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static WishlistItemWishlistResourceEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getWishlistItemWishlistResourceEndpoints();
    }
