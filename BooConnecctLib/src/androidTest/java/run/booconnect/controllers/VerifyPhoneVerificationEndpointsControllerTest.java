...
import run.booconnect.controllers.VerifyPhoneVerificationEndpointsController;
...
@LargeTest
public class VerifyPhoneVerificationEndpointsControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static VerifyPhoneVerificationEndpointsController controller;
    ...
    public static void setUpClass() {
        ...
        controller = getClient().getVerifyPhoneVerificationEndpoints();
    }
